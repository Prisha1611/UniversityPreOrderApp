...
public class CafeLatta extends AppCompatActivity {
    private Button btn4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cafe_latta);
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(c5.isChecked()){
                    ...
                    pr.add((200*v5)+"");
                    qn.add(v5+"");
                    str.add("Cheese Sandwich");
                }
                String h = sum+"";
                Toast.makeText(CafeLatta.this, h, Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(CafeLatta.this,OrderPage.class);
